...
function generateMiddlewareContent(name: string): string {
...
function generateInterceptorContent(name: string): string {
...
function generateGuardContent(name: string): string {
